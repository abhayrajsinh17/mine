...
const animationTimeline = () => {
  ...
  // 🔹 Slow everything down (adjust value as you like: 0.5 = half speed, 0.7 = 70%)
  tl.timeScale(0.6);
  ...
  tl
    ...
    .staggerFromTo(".wish-hbd span", 0.3,
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  // Play music when user clicks anywhere (bypass browser autoplay restrictions)
